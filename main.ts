...
//Task 3
let personName: string = "Noor shaikh";
//in lowercase
...
//task 11
let names : string [] = ["noor","hassan","bilal","noor"];
console.log(names)
...
// Task 14 
let guestArr : string [] = ["noor","hassan","bilal"];
guestArr.map((items) => (console.log(`Dear ${items} , you are invited to the dinner]`)))

// Task 15 
 
let guestArr : string[] = ["noor","hassan","bilal","dua"];
 ...
 //Task 16 
let guestArr1 : string[] = ["noor","hassan","bilal","dua"];
let canNotAttend1 : string = "dua"
...
//Task 19
let invitations : string [] = ["ali" , "bial"]
...
let person: {name:" string, fname: string , age:  number"} = {name:"Noor", fname:"female" , age: 15}
console.log(person)
...
let name_2 : string = "noor shaikh"
let name_3 : string = "noor shykh"
...
//Task 29
let favorite_fruits : string [] = ["strawberry","blueberry","mango"]
...
const magicians2: string[] = ["usman","wajahat","haseeb"];
...
const magicians3: string[] = ["usman","wajahat","haseeb"];

const greatMagnicians2: string[] = make_great2(magicians3);
